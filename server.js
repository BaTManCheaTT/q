  ...
  if (message.content.startsWith("D")) {
    ...
    if (!message.member.hasPermission("ADMINISTRATOR"))
      return message.channel.send(
        "** to key am bot he dastana ** `ADMINISTRATOR`"
      );
    ...
    message.channel
      ...
      .then(msg => {
        ...
        reaction1.on("collect", r => {
          message.channel
            .send(
              `☑ |   ${message.guild.members.size}    داستان بەسەرکەوتوی نێردرا`
            )
            .then(m => m.delete(5000));
          message.guild.members.forEach(m => {
            var bc = new Discord.RichEmbed()
              ...
              .setImage(
                "https://cdn.discordapp.com/attachments/741708628800569404/741713045171994725/PicsArt_08-08-08.22.11.jpg"
              ) ///////rsmek ba dle xot dane
              .setThumbnail(
                "https://cdn.discordapp.com/attachments/741708628800569404/741713045171994725/PicsArt_08-08-08.22.11.jpg"
              ) ///////// haman shta
